...
INSERT INTO product (name, price, rating, category_id) VALUES ('product B', 200, 3, 1);
INSERT INTO product (name, price, rating, category_id) VALUES ('product A', 101, 4, 3);
INSERT INTO product (name, price, rating, category_id) VALUES ('product C', 150, 1, 2);
...
INSERT INTO lab3user (email, first_name, last_name, password, id_address) VALUES ('adam.smith@miu.edu', 'Adam', 'Smith', '1234', 1);
INSERT INTO lab3user (email, first_name, last_name, password, id_address) VALUES ('thi.truong@miu.edu', 'Thi', 'Truong', '1234', 2);
INSERT INTO lab3user (email, first_name, last_name, password, id_address) VALUES ('peter.pan@miu.edu', 'Peter', 'Pan', '1234', 3);
